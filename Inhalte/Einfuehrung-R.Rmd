...
knitr::include_graphics(file.path(pathToImages, "Kochen_mit_RStudio.jpg"), error=FALSE)
```
...
Die dabei angezeigten folgenden Meldungen^[`mosaic` Version `r packageVersion("mosaic")`] sind nur Hinweise, [keine]{.cemph} Fehler:
