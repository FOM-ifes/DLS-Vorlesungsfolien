...
```{r fig-low-high-rsquared, echo = FALSE, fig.align="center", out.width="55%", fig.asp = 0.5}
df1 <- tibble(
  x = rnorm(100),
...
```{r simushuffle, echo=FALSE, fig.align="center", out.width="75%"}
...
```{r do-tips2, echo=FALSE, fig.align="center", out.width="60%"}
...
## Regression mit kategorialer unabhängiger Variable {.shrink, exclude=bda}
...
```{r ref.label="gf-point-tip-smoker", eval=TRUE, echo=FALSE, out.width = "55%", fig.align="center"}
```
...
```{r lm-boot, out.width = "35%", fig.align="center", echo = FALSE}
set.seed(1896)
...
::: {.column width="39%"}
::: {.sciptsize}
```{r lm-smoker-shuffle, out.width = "80%", fig.align="center", echo=FALSE}
set.seed(1896)
...
```
```{r MMR-Ausgabe, out.width = "70%", fig.align="center", echo=FALSE}
...
```{r plot-wechselwirkung, echo=FALSE, eval = TRUE, out.width = "85%", fig.align="center"}
