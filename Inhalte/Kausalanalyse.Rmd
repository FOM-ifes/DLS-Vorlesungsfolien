...
```{r plot-lwv2, echo=FALSE, out.width = "75%", fig.align="center"}
...
```{r plot-dag-e1, echo=FALSE, out.width = "60%", fig.align="center"}
...
::: {.notes}
```{r plot-path-causal, echo=FALSE, out.width="45%", fig.align="center"}
set.seed(1896)
...
::: {.notes}
```{r plot-adj-causal-sol, echo=FALSE, out.width="35%", fig.align="center"}
plotsol
```
