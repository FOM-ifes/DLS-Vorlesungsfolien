...
```{r EDA_Titanic, echo=FALSE, out.width = "60%", fig.align="center", cache=FALSE}
data("Titanic")
...
```{r eval=FALSE, echo=TRUE, fig.align='center', out.width="55%"}
mosaicplot(day ~ smoker, data = tips)
```
```{r evaL=TRUE, echo=FALSE, fig.align='center', out.width="55%"}
...
```{r histogram, fig.align="center", out.width="45%"}
...
```{r histogramlog, fig.align="center", out.width="40%"}
...
```{r echo=FALSE, out.width = "58%", fig.align="center", message=FALSE}
set.seed(1896)
xs1 <- rnorm(1000)
xs2 <- rnorm(1000, sd = 2)
xs3 <- runif(1000, -6, 6)
...
:::{.small}
```{r fig.width = 5, out.width="5cm", fig.asp = 0.6}
...
```{r rho-delta-rect, fig.asp = 0.8, echo = FALSE, out.width="70%"}
...
```{r Visualisierung_Korrelation, fig.align="center", echo=FALSE, out.width="70%"}
...
```{r xyplot, fig.align="center", out.width="45%"}
